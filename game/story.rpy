label story:
    ...
    n "WHAT THE FUCK!!!"
    s "What was that?"
    player "I don't know but we need to help."
    ...
    n "No I don't need the help of you two, I'll do it myself."
    show sayori 1f at t21
    player "Are you sure Natsuki?"
    show natsuki 4e at t22
    n "Yes I am Sure"
    player "Ok then, Sayori let's go eat something now."
    show natsuki 1c at t22
    "Natsuki's Eyes light up as I said that"
    "But she doesn't says anything"
    hide sayori
    hide natsuki
    ...
    show sayori 1h at t11
    s "I know [player] but it just can't get out of my Head."
    player "Then I know exectly what to cook for you."
    ...
    s "Meanie"
    "I ignore that comment and just Walk home"
    hide sayori
    ...
    show monika 3h at t22
    show sayori 1a at t21
    m "Were where you [player], I waited for you!"
    player "OMG, Monika sorry that I have forgotten about you, but something came in the way and I somehow forgot."
    show monika 1r at t22
    m "It's alright [player], were here now so can I ask you now?"
    player "You can ask me inside my House, I just wanted to cook for Sayori something."
    player "You know how she don't have any talent with cooking."
